  ...
  return (
    <div className="home h-[100vh] flex justify-center">
      <div className="flex z-30 justify-center flex-wrap lg:px-32 lg:max-w-[1080px] m-auto pt-32">
        <h1 className="lg:text-6xl text-5xl text-center font-bold mb-6 tracking-tight text-white">
        ...
        />
        <h1 className="text-center text-3xl font-bold mt-12 px-7 basis-full tracking-tight text-white">
